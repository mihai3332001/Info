...
namespace Orase.Models
{
	...
	public partial class CtiesDBMLDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteOra(Ora instance);
		...
		public CtiesDBMLDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public CtiesDBMLDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public CtiesDBMLDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public CtiesDBMLDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnNameChanged();
		...
		public EntitySet<Bilet> Bilets
		{
			...
			{
				if ((this.serializing 
							&& (this._Bilets.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
				return this._Bilets;
 ...
 public partial class Judet : INotifyPropertyChanging, INotifyPropertyChanged
    ...
    partial void OnJudet1Changed();
		...
		public EntitySet<Ora> Oras
		{
			...
			{
				if ((this.serializing 
							&& (this._Oras.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
				return this._Oras;
    ...
    partial void OnLongChanged();
		...
		public EntitySet<Transport> Transports
		{
			...
			{
				if ((this.serializing 
							&& (this._Transports.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
		...
		public EntitySet<GM> GMs
		{
			...
			{
				if ((this.serializing 
							&& (this._GMs.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
				return this._GMs;
		...
		public EntitySet<Locatie> Locaties
		{
			...
			{
				if ((this.serializing 
							&& (this._Locaties.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
